...
if __name__ =="__main__":
    ...
    train_data_path_2007 = '/media/fq/disk_8T/tcl_work/VOCdevkit/VOC2007'
    train_data_path_2012 = '/media/fq/disk_8T/tcl_work/VOCdevkit/VOC2012'
    train_annotation_path = '/media/fq/disk_8T/tcl_work/VOCdevkit/train_annotation.txt'
    if os.path.exists(train_annotation_path):
        os.remove(train_annotation_path)

    # val_set   : VOC2007_test
    test_data_path_2007 = '/media/fq/disk_8T/tcl_work/VOCdevkit/VOC2007'
    test_annotation_path = '/media/fq/disk_8T/tcl_work/VOCdevkit/test_annotation.txt'

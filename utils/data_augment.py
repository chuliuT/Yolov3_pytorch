...
if __name__ == '__main__':
    ...
    img=cv2.imread('010001.jpg')
    # boxes=np.array([[501,317,501+30,317+58],[585,25,585+316,25+414]])
    # img2,boxes2 = RandomCrop(p=0.8)(img,boxes)
    #
    # # for item in boxes:
    # #     cv2.rectangle(img,(item[0],item[1]),(item[2],item[3]),(255,0,0),1)
    # # import matplotlib.pyplot as plt
    # # plt.imshow(img)
    # # plt.show()
    #
    # rs=Resize(target_shape=(256,256))
    # img2, boxes2=rs(img2,boxes2)
    #
    # for item in boxes2:
    #     cv2.rectangle(img2,(item[0],item[1]),(item[2],item[3]),(255,0,0),1)
    # import matplotlib.pyplot as plt
    # plt.imshow(img2)
    # plt.show()
    src_pts = np.float32([
    ...
    roi=cv2.warpAffine(img,M,(100,100))
    import matplotlib.pyplot as plt
    plt.imshow(roi)
    plt.show()
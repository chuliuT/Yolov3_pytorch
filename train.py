...
class Trainer(object):
    def __init__(self, weight_path, resume, gpu_id):
        ...
        self.yolov3 = Darknet('config/yolov3.cfg').to(self.device)
    ...
    def __load_model_weights(self, weight_path, resume):
        if resume:
            ...
            self.yolov3.load_darknet_weights(weight_path, cutoff=74)
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            #     with torch.no_grad():
            #         APs = Evaluator(self.yolov3).AP_VOC()
            #         for i in APs:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight_path', type=str, default='weights/yolov3.weights', help='weight file path')
